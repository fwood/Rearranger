...
\mbox{
\subfigure{
\includegraphics[width=.25\textwidth]{figures/alpha.eps}
\label{fig-2}
}\quad
\subfigure{
\includegraphics[width=.25\textwidth]{figures/beta.eps}
\label{fig-3}
}\quad
\subfigure{
\includegraphics[width=.25\textwidth]{figures/harmonyM3.eps}
\label{fig-4}
}\quad
\subfigure{
\includegraphics[width=.25\textwidth]{figures/notemovementdownhalfstep.eps}
\label{fig-5}
}
}
%\centering
